...
class PromiseThrottle {
  ...
  Add(a) {
    return new Promise((e, t) => {
      this._queue.push({ func: a, resolve: e, reject: t }), this._MaybeStartNext();
    });
  }
...
function fetchWithBypass(e, t) {
  return "string" == typeof e && (e = new Request(e)), t ? fetch(e.url, { headers: e.headers, mode: e.mode, credentials: e.credentials, redirect: e.redirect, cache: "no-store" }) : fetch(e);
}
    ...
    if (i) {
      ...
      const l = await GetMainPageUrl(),
        d =
          ...
          console.log(CONSOLE_PREFIX + "Caching " + s.length + " files for offline use"),
