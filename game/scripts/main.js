  ...
  _PostToRuntimeMaybeSync(t, i, e) {
    this._iRuntime.UsesWorker()
      ...
      : this._iRuntime
          ...
          [
            '_OnMessageFromDOM'
          ]({ type: 'event', component: this._componentId, handler: t, dispatchOpts: e || null, data: i, responseId: null });
  }
    ...
    Call() {
      if (-1 === this._timerId) {
        ...
        e <= i && this._canRunImmediate
          ...
          : (this._timerId = self.setTimeout(this._timerCallFunc, Math.max(e - i, 4)));
      }
    }
    _RunCallback() {
  ...
  window.DOMElementHandler = class extends self.DOMHandler {
    ...
    _OnUpdatePosition(e) {
      if (this._autoAttach) {
        ...
        d !== t.GetHTMLZIndex() && (t.SetHTMLZIndex(d), s._UpdateHTMLElementsZOrder()),
          t.HadFirstUpdate() ||
  ...
  window.RuntimeInterface = class Q {
    constructor(e) {
      ...
      this.IsAnyWebView2Wrapper()
        ...
        this.AddRuntimeComponentMessageHandler('canvas', 'set-html-layer-count', e =>
          this['_OnSetHTMLLayerCount'](e)
        ),
        this.AddRuntimeComponentMessageHandler('canvas', 'cleanup-html-layers', () =>
        ...
        this.AddRuntimeComponentMessageHandler('runtime', 'cordova-fetch-local-file', e =>
          this._OnCordovaFetchLocalFile(e)
        ),
        this.AddRuntimeComponentMessageHandler('runtime', 'create-job-worker', e =>
          this._OnCreateJobWorker(e)
        ),
        this.AddRuntimeComponentMessageHandler(
          'runtime',
    ...
    *_CanDoAndroidVirtualKeyboardDetection() {
    ...
    async _Init(e) {
      ...
      if (e.runtimeBaseUrl) this._runtimeBaseUrl = e.runtimeBaseUrl;
        ...
        const n = location.origin,
          a =
            ((this._runtimeBaseUrl = ('null' === n ? 'file:///' : n) + location.pathname),
    ...
    _GetCommonRuntimeOptions(e) {
      return {
        ...
        fileMap:
          globalThis.c3_swFileMap ?? new Map(Object.entries(this._localFileBlobs ?? {})),
    ...
    async _InitDOM(e, t) {
      const s = document.createElement('canvas'),
        ...
        i =
          ...
          await Promise.all(
            e.runtimeScriptList.map(e => this._MaybeGetPlatformSpecificScriptURL(e))
          )),
      ...
      if (!this.IsExportingToVideo()) {
        ...
        for (const { canvas: n, htmlWrap: a } of this._canvasLayers)
          (n.style.width = t),
            ...
            (a.style.marginTop = i),
            this._isFirstSizeUpdate && ((n.style.display = ''), (a.style.display = ''));
    ...
    ['_OnSetHTMLLayerCount'](e) {
      ...
      return this._UpdateHTMLElementsZOrder(), { addedCanvases: l, transferables: c };
    }
    _UpdateHTMLLayerDOMProperties(s) {
      for (let e = 0, t = Math.min(this._canvasLayers.length, s.length); e < t; ++e) {
        const { htmlWrap: r, lastHtmlLayerDomState: i } = this._canvasLayers[e],
          ...
          o = n['opacity'],
          l = n['isInteractive'];
        a !== i.isVisible && ((r.style.display = a ? '' : 'none'), (i.isVisible = a)),
          o !== i.opacity &&
    ...
    async _MaybeGetPlatformSpecificScriptURL(t) {
      if (
        'cordova' === this._exportType &&
        (t.startsWith('file:') || (this._isFileProtocol && this.IsRelativeURL(t)))
      ) {
        let e = t;
    ...
    _HasPermission(s) {
      ...
      return new Promise((t, e) =>
        r['checkPermission'](this._MapPermissionID(r, s), e => t(!!e['hasPermission']), e)
      );
    }
    ...
    _OnWrapperMessage(e, t) {
      if ('entered-fullscreen' === e)
        Q._SetWrapperIsFullscreenFlag(!0), this._runtimeDomHandler._OnFullscreenChange();
      else if ('exited-fullscreen' === e)
        Q._SetWrapperIsFullscreenFlag(!1), this._runtimeDomHandler._OnFullscreenChange();
    ...
    j = class extends self.DOMHandler {
      constructor(e) {
        super(e, i),
          ...
          e.AddRuntimeComponentMessageHandler('runtime', 'invoke-download', e =>
            this._OnInvokeDownload(e)
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'load-webfonts', e =>
            this._OnLoadWebFonts(e)
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'raster-svg-image', e =>
            this._OnRasterSvgImage(e)
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'get-svg-image-size', e =>
            this._OnGetSvgImageSize(e)
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'set-target-orientation', e =>
            this._OnSetTargetOrientation(e)
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'register-sw', () =>
            this._OnRegisterSW()
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'post-to-debugger', e =>
            this._OnPostToDebugger(e)
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'go-to-script', e =>
            this._OnPostToDebugger(e)
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'before-start-ticking', () =>
            this._OnBeforeStartTicking()
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'debug-highlight', e =>
          ...
          e.AddRuntimeComponentMessageHandler('runtime', 'enable-device-motion', () =>
            this._AttachDeviceMotionEvent()
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'add-stylesheet', e =>
            this._OnAddStylesheet(e)
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'script-create-worker', e =>
            this._OnScriptCreateWorker(e)
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'alert', e => this._OnAlert(e)),
          e.AddRuntimeComponentMessageHandler('runtime', 'screen-reader-text', e =>
            this._OnScreenReaderTextEvent(e)
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'hide-cordova-splash', () =>
            this._OnHideCordovaSplash()
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'set-exporting-to-video', e =>
            this._SetExportingToVideo(e)
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'export-to-video-progress', e =>
            this._OnExportVideoProgress(e)
          ),
          e.AddRuntimeComponentMessageHandler('runtime', 'exported-to-video', e =>
            this._OnExportedToVideo(e)
          ),
          e.AddRuntimeComponentMessageHandler(
            'runtime',
      ...
      _TrySetTargetOrientation() {
        ...
        if (screen['orientation'] && screen['orientation']['lock'])
          screen['orientation']
            ['lock'](t)
            .catch(e => console.warn('[Construct] Failed to lock orientation: ', e));
        else
          try {
            let e = !1;
  ...
  self.JobSchedulerDOM = class {
    ...
    async Init() {
      ...
      const t = this._runtimeInterface.GetScriptFolder() + a,
        r =
          ((this._dispatchWorker = await this._runtimeInterface.CreateWorker(t, {
            name: 'DispatchWorker',
          })),
          new MessageChannel());
      (this._inputPort = r.port1),
        this._dispatchWorker.postMessage({ type: '_init', 'in-port': r.port2 }, [
          r.port2,
        ]),
    ...
    async _CreateJobWorker() {
      const t = this._jobWorkers.length,
        ...
        e = await this._runtimeInterface.CreateWorker(r, { name: 'JobWorker' + t }),
        o = new MessageChannel(),
        s = new MessageChannel();
      return (
        this._dispatchWorker.postMessage({ type: '_addJobWorker', port: o.port1 }, [
          o.port1,
        ]),
        e.postMessage(
          { type: 'init', number: t, 'dispatch-port': o.port2, 'output-port': s.port2 },
          [o.port2, s.port2]
        ),
    ...
    b = class extends self.DOMHandler {
      ...
      async _RequestOrientationPermission() {
        ...
        try {
          ...
          return (
            console.warn('[Touch] Failed to request orientation permission: ', e), !1
          );
        }
      }
  ...
  (self.AudioDOMHandler = class extends self.DOMHandler {
    ...
    _ReconnectEffects(t) {
      ...
      this._microphoneSource &&
        ...
        (this._microphoneSource['disconnect'](), this._microphoneSource['connect'](e));
    }
    GetMasterVolume() {
    ...
    *audioInstancesByEffectTag(t) {
    ...
    async _GetAudioBuffer(t, e, s, i, n) {
      for (const a of this._audioBuffers) if (a.GetUrl() === e) return await a.Load(), a;
      if (n) return null;
      i &&
    ...
    _AddPendingTags(t) {
      ...
      if (!i) {
        ...
        (i = { pendingCount: 0, promise: n, resolve: e }), this._pendingTags.set(s, i);
      }
      i.pendingCount++;
    }
    ...
    async _AddEffect(t) {
      ...
      for (const a of s) {
        if ('filter' === e) n = new self.C3AudioFilterFX(this, ...i);
          ...
          (n = new self.C3AudioConvolveFX(this, o.GetAudioBuffer(), ...i))._SetBufferInfo(
            t['bufferOriginalUrl'],
            t['bufferUrl'],
            t['bufferType']
          );
    ...
    _DoPostUpdatedFxState() {
      ...
      this.PostToRuntime('fxstate', { fxstate: t }), (this._isPendingPostFxState = !1);
    }
...
self.C3AudioBuffer = class {
  ...
  CreateInstance(t) {
    return new (
      'html5' === this._api ? self.C3Html5AudioInstance : self.C3WebAudioInstance
    ...
    FadeVolume(e, t, n) {
      if (!this.IsMuted()) {
        const i = this._gainNode['gain'],
          s =
            (i['cancelScheduledValues'](0), this._audioDomHandler.GetAudioCurrentTime()),
          a = s + t;
      ...
      if (this._isPannerEnabled) {
        ...
        this._pannerConeParams[0] !== r(s) &&
          ...
          this._pannerConeParams[2] !== o &&
            ((this._pannerConeParams[2] = o), (this._pannerNode['coneOuterGain'] = o));
      }
    }
    SetPanXYZA(e, t, n, i) {
      if (this._isPannerEnabled) {
        const s = this._pannerPosition,
          ...
          r = Math.sin(i);
        (s[0] === e && s[1] === t && s[2] === n) ||
          ((s[0] = e), (s[1] = t), (s[2] = n), this._pannerNode['setPosition'](...s)),
          (a[0] === o && a[1] === r && 0 === a[2]) ||
            ((a[0] = o),
            (a[1] = r),
            (a[2] = 0),
  ...
  (self.C3AudioFilterFX = class extends a {
    ...
    (self.C3AudioGainFX = class extends a {
      ...
      SetParam(e, t, i, s) {
        const o = self.AudioDOMHandler.DbToLinear;
        4 === e &&
          ((this._params[0] = o(t)), this.SetAudioParam(this._node['gain'], o(t), i, s));
      }
    }),
