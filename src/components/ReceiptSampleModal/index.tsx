...
const ReceiptSample: React.FC<ReceiptSampleProps> = ({ open, onClose }) => {
  ...
  const slides = [
    ...
    },
    {
      ...
      list: [
        'Open Shopee app, go to ‘Me’ tab and select ‘View Purchase History’.',
        'Select your order.',
        'Under ‘Order ID’ section, click ‘View’ next to the ‘Receipt’.',
        'Select ‘Receipt’ and it will be sent to your email.',
        'Check your email inbox / junk mail to look for the invoice attachment as shown below.',
      ],
      image: sample2,
    },
    {
      ...
      list: [
        'Open Lazada app, go to ‘Account’ and select ‘View All Orders’.',
        'Select your order.',
        'Click More and Select Receipt',
        'At the bottom under the ‘More’ section, select ‘E-invoice’.',
        'Check your email inbox / junk mail to look for the invoice attachment as shown below.',
      ],
      image: sample3,
    },
